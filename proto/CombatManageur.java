...
public class CombatManageur {
    ...
    public void SeBattre(lesPersonnagesEnCombat _lesPerso) {
         ...
         * if (leJoueurCommence) {
         * // Instruction pour le cas où le joueur commence.
         * _pointDeVieRestantDeEnnemi = perso.GetEnnemisActuel().GetVie() -
         * FormuleDegatPourEnnemi();
         * System.out.println("Vous attaquez votre adversaire.\n Il lui reste " +
         * _pointDeVieRestantDeEnnemi + ".");
         * _pointDeVieRestantDuJoueur = perso.GetLePersonnageJouable().GetVie() -
         * FormuleDegatPourJoueur();
         * System.out.
         * println("C'est au tour de votre ennemi de vous attaquer.\nIl vous rest " +
         * _pointDeVieRestantDuJoueur);
         * } else {
         * // Instruction pour le cas où l'ennemi commence.
         * _pointDeVieRestantDuJoueur = perso.GetLePersonnageJouable().GetVie() -
         * FormuleDegatPourJoueur();
         ...
         * FormuleDegatPourEnnemi();
         * System.out.
         * println("C'est à votre tour d'attaquer votre adversaire.\n Il lui reste " +
         * _pointDeVieRestantDeEnnemi + ".");
         * }
         * 
         * } while (_pointDeVieRestantDeEnnemi > 0 || _pointDeVieRestantDuJoueur > 0);
